...
public class ProxyUtils {
    ...
    public static boolean setProxy(WebView webview, String host, int port, String applicationName) {
        ...
        if (sdkInt < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            return setProxyKK(webview, host, port, applicationName);
        } else if(sdkInt < Build.VERSION_CODES.M){
            return setProxyLollipop(webview.getContext(), host, port);
        } else {
            return setProxyLPlus(webview, host, port, "exclusion" , applicationName);
        }
    }
    ...
    public static boolean clearProxy(WebView webView) {
        ...
        if (sdkInt < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            return setProxyLPlus(webView, null, 0, "exclusion" , "android.app.Application");
        }
    }
    ...
    private static boolean setProxyLPlus(WebView webView, String host, int port, String exclusion, String applicationClassName) {
        Log.i(LOG_TAG, "try to setProxyKKPlus");
        if (null == host) {
            System.clearProperty("http.proxyHost");
            System.clearProperty("http.proxyPort");
            System.clearProperty("http.nonProxyHost");
            System.clearProperty("https.proxyHost");
            System.clearProperty("https.proxyPort");
        ...
        try {
            ...
            Log.d(LOG_TAG, "Setting proxy > Lollipop API successful!");

        } catch (Exception e) {
            //            Log.i("setProxyKKPlus - exception : {}", e);
            return false;
        }
        return true;
    }
